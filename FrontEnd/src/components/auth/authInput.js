  export const inputsByStep = {
    // 1단계에서 사용할 입력 필드 정의
    step1: [
      { name: 'user_id', type: 'text', placeholder: '아이디', side: 'left' },
      { name: 'user_pwd', type: 'password', placeholder: '비밀번호', side: 'left' },
      { name: 'user_pwd_check', type: 'password', placeholder: '비밀번호 확인', side: 'left' },
    ...
    step2: {
      typeA: [
        { name: 'company_name', type: 'text', placeholder: '회사명', side: 'left' },
        ...
        { name: 'company_email', type: 'text', placeholder: '회사 이메일', side: 'right' },
        { name: 'company_phone', type: 'text', placeholder: '회사 전화번호', side: 'right' },
      ],
      typeB: [
        { name: 'company_name', type: 'text', placeholder: '기업명', side: 'left' },
        { name: 'business_id', type: 'text', placeholder: '숫자만 10자리 입력', side: 'left' },
        { name: 'business_name', type: 'text', placeholder: '사업자명', side: 'left' },
        { name: 'open_date', type: 'text', placeholder: '개업일', side: 'left' },
